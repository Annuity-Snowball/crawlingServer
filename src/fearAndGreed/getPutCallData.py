...
def get_put_call_data(temp_path):
    ...
    driver.get("http://data.krx.co.kr/contents/MDC/MDI/mdiLoader/index.cmd?menuId=MDC0201050403")
    ...
    search_btn = driver.find_element(By.CSS_SELECTOR, '#MDCSTAT136_FORM > div.CI-MDI-UNIT-WRAP > div > p:nth-child(2) > button.CI-MDI-UNIT-DOWNLOAD > img')
    search_btn.click()
    rand = random.randrange(2, 4)
    time.sleep(rand)
